...
import { LinksArray, SecondaryLinksArray, ToggleTheme } from "../../../index";
import { v } from "../../../styles/variables";
import { NavLink } from "react-router-dom";
import { Icon } from "@iconify/react";
export const MenuMobile = ({ isOpen, setState }) => {
  const [state, setstate] = useState(isOpen);

  return (
    <ContainerMenu $isopen={state.toString()}>
      <MainMenu $isopen={state.toString()}>
        <ContainerMenu
